...
# Calculando a média dos dados utiliando a função mean()
media = statistics.mean(dados)

print(f'Média: {media}')

# OBS: Assim como função map(), a filter() recebe dois parâmetros, sendo
...
usuarios = [
    ...
    {"username": "doggo", "tweets": ["Eu gostos de cachorros", "Vou sair hoje"]},
    {"username": "gal", "tweets": []},
]
