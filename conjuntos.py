...
Diferença etnre Conjuntos (Sets) e Mapas (Dicionários) em Python:
...
# Imagine que fizemos um formulário de cadastro em uma feira ou museu e os visitantes informam a cidade de onde vieram.

# Nós adicionamos cada cidade em uma lista Python, já que em uma lista podemos adicionar novos elementos e ter repetições
...
#unicos1 = estudantes_python.union(estudantes_java)
#{'Patrícia', 'Julia', 'Fernando', 'Ellen', 'Marcos', 'Ana', 'Guilherme', 'Pedro', 'Gustavo'}

#unicos1 = estudantes_java.union(estudantes_python)
#{'Ellen', 'Guilherme', 'Julia', 'Fernando', 'Ana', 'Gustavo', 'Pedro', 'Marcos', 'Patrícia'}
print(unicos1)
