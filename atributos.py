...
Caso queiramos demonstrar que determinado atributo deve ser tratado como privado, ou seja, que deve ser acessado/utilizado dentro da própria classe onde está declarado, utiliza-se __ duplo underscore no início do seu nome.
...
# Não precisamos criar uma instância de uma classe para fazer um acesso a um atributo de classe
