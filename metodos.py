...
Usuario.conta_usuarios() # Forma corret
...
class Usuario:
    ...
    def conta_usuarios(cls):
        print(f'Classe: {cls}')
        print(f'Tem(os) {cls.contador} usuário(s) no sistema')
    ...
    def __init__(self, nome, sobrenome, email, senha):
        ...
        self.__email = email
        # self.__senha = cryp.encrypt(senha, rounds=200000, salt_size=16) # Deprecated
