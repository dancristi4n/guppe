...
bloco_da_funcao -> Também chamado de corpo função ou implementação, é onde o processamento da função acontece. Neste bloco, pode ter ou não retorno da função.

OBS: Veja que para definir uma função, utilizamos a palavra reservada 'def', informando ao Python ue estamos definindo uma função. Também abrimos o bloco de códio com o já conhecido dois pontos : que é utilizado em Python para definir blocos
"""
