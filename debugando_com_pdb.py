...
# Existem formas mais profissonais de se fazer esse 'debug', utilizando o debugger. Em Python podemos fazer isso em diferentes IDEs, como o VSCode ou utilizando. O PDB - Python Debugger.
...
# O debug é utilizado durante o desenvolvimento. Costumamos realizar todos os imports de biblioetecas no início do arquivo. Por isso, ao invés de colocarmos o import do pdb no início do arquivo, nós colocarmos somente onde vamos debuggar, e ao finalizar já fazemos a remoção.
...
# Como os nomes das variávies são os mesmos dos comandos pdb, devemos utilizar o comando p para imprimir as variáveis. Ou seja: p nome_da_variavel
