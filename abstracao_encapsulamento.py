...
O objetivo da POO é encapsular o nosso código dentro de um grupo lógico e hierárquico utilizando classes.
...
Esses elementos privados só devem/deveriam ser acessados dentro da classe. Mas Python não bloqueia este acesso fora da classe. Com Python acontece um fenômeno chamado Name Mangling, que faz uma alteração na forme de se acessar os elementos privados, conforme:
...
class Conta:
    ...
    def transferir(self, valor, conta_destino):
        ...
        self.__saldo -= valor
        self.__saldo -= 10 # Taxa de transferência por quem realizou a transferência
        # 2 - Adicionar valor na conta de destino
