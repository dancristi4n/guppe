...
# o objeto com a chave informada
pais = paises.get('py', 'Não encontrado')
print(f'Encontrei o pais {pais}')

# Podemos verificar se determinada chave se encontra em 
# um dicionário
...
# Podemos utilizar qualquer tipo de dados (int, float, string,
# boolean) inclusive lista, tupla, dicionário como 
...
# CONCLUSÃO 1: A forma de adicionar novos elementos ou atualizar 
...
# OBS 1: Aqui precisamos sempre informar a chave, e caso não encontre
# o elemento, um KeyError é retornado

# OBS 2: Ao remover um objetivo, o valor deste objeto é sempre retornado
...
# Imagine que você tem um comercio eletronico
# onde temos um carrinho de comprar no qual adicionamos produtos
...
# 3 - Poderíamos utilizar um Dicionários para isso? Sim
...
# Ele vai gerar para cada valor do iterável uma chave e irá atribuir
