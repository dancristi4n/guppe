...
múltiplas classes, fazendo com que a classe filha herde todos os atributos e métodos
...
class Pinguim(Aquatico, Terrestre):  # A ordem da declaração faz diferença
