...
Poderíamos chamar este parâmetro de **xis, mas pode convenção chamamos de **kwargs

Este é só mais um parâmetro, mas diferente do *args que coloca os valores extras em uma tupla, o **kwargs exige que utilizamos parâmetros nomeados, e transforma estes parâmetros extas em um dicionário.
