...
Se um programa Python for executado com o paramentro -O, nenhum assertion
será validado. Ou seja, todas as suas validação já eram.
...
def comer_fast_food(var_comida):
    assert var_comida in [
        'pizza',
        'sorvete',
        'doces',
        'batata frita',
    ...
    return f'Estou comendo {var_comida}'
