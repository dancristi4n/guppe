...
print('x'.join('Geek University'))

# Round

round() -> Retorna um número arredondado para o n digito de precisao após a casa decimal. Se a precisão não for informada retorna o inteiro mais proximo da entrada.
