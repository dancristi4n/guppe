...
- POO é um paradigma de programação que utilizada que mapeamento de objetos do mundo real para modelos computacionais.

- Paradigma de programção é a forma/metodologia utilizada para pensar/desenvolver sistemas.
